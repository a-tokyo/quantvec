#!/usr/bin/env node
// Download the dbpedia-OpenAI-100k ann-benchmarks-format HDF5 file (~1.18 GB).
// Source: https://storage.googleapis.com/ann-datasets/ann-benchmarks/ — a mirror of the
// dbpedia-entities-openai-1M dataset (1536-d text-embedding-ada-002 vectors), reshaped
// to the standard ann-benchmarks train/test/neighbors layout. The original
// ann-benchmarks.com host returns 403 for the dbpedia-openai-*-angular files (#460).
// Usage: node benchmarks/download-openai.mjs
